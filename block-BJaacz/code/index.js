...
addTwoToArray([3,6,1,6,9],addTwo);
...
addTwoToArray([3,6,1,6,9],addThree);
...
let clfunctn=callMe(function myfuctn()
{
  return `hello world`;
})
...
let myObject1={name:"shubham",age:65};
console.log(isAdult(myObject1));
/*
